...
create table IF NOT EXISTS BLOCK(
    ...
    LAST_PROOVED TIMESTAMPTZ DEFAULT NULL,
    PARTITION_SEQ INT NOT NULL DEFAULT 0,
    BLOCK_SEQ INT NOT NULL DEFAULT 0,
    CHECKSUM BOOL NOT NULL DEFAULT false,
...
create table IF NOT EXISTS PROOF_METADATA(
    ...
    PARAM_STR STRING(1024) NOT NULL,
    GENERATOR BYTES NOT NULL,
    PUB_KEY BYTES NOT NULL,
    RANDOM BYTES NOT NULL,
    PHI_LENGTH int[] NOT NULL,
    PHI_DATA BYTES NOT NULL,
    UNIQUE (FILE_ID,HASH)
);

create table IF NOT EXISTS BLOCK_MISS_RECORD(
    ID UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    HASH STRING(30) NOT NULL,
    SIZE INT NOT NULL,
    CREATION TIMESTAMPTZ NOT NULL,
